    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-4 sm:mb-5 lg:mb-6">
          <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-1 sm:mb-2 group-hover:text-pink-400 transition-all duration-500 group-hover:scale-105 line-clamp-1">
            {member.name}
          </h3>
