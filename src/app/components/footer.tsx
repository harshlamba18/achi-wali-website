...
export default function Footer() {
  return (
    <div className="w-full bg-stone-900/50 flex py-8 px-48">
      <div className="flex flex-col justify-center items-baseline-last gap-4">
        <div className="flex justify-center items-center">
          <Image src={CGSLogo} alt="logo" />
          <h1 className={`text-8xl font-mono ${squade_font.className}`}>CGS</h1>
        </div>
        ...
        <div className="flex gap-8 w-2/3 justify-center mt-4">
          ...
          >
            ...
            >
              ...
              <rect x="15" y="20" width="3" height="10" rx="1.5" fill="#fff" />
              <circle cx="16.5" cy="17.5" r="1.5" fill="#fff" />
              <rect x="21" y="20" width="3" height="10" rx="1.5" fill="#fff" />
              <path
